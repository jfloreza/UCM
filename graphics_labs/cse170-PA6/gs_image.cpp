...
gsuint GsImage::ogl_bind_texture()
 {
   gsuint id = 0;
   glGenTextures ( 1, &id );
   ...
   gluBuild2DMipmaps(GL_TEXTURE_2D, 4, w(), h(), GL_RGBA, GL_UNSIGNED_BYTE,  data() ); // mipmap building is quite slow for large images
   return id;
 }
